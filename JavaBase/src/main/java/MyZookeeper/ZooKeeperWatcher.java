...
public class ZooKeeperWatcher implements Watcher {
	...
	/** zookeeper服务器地址 */
	private static final String CONNECTION_ADDR = "192.168.6.128:2181,192.168.6.129:2181,192.168.6.130:2181";
	/** zk父路径设置 */
	 ...
	 * @return 
	 */
	public boolean createPath(String path, String data,Boolean flag) {
		try {
